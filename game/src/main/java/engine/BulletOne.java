...
public class BulletOne extends Character {
	...
	public BulletOne(int positionX, int positionY, int velocityX, int velocityY, int width, int height) {
		...
		this.getImages().add(new Image("file:images/bulletOne/bulletOne001.png"));
		this.getImages().add(new Image("file:images/bulletOne/bulletOne002.png"));
		this.getImages().add(new Image("file:images/bulletOne/bulletOne003.png"));
	}
