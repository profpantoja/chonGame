...
public class Engine extends Application {
    ...
    public void start(Stage theStage) {
        try {
            ...
            timeText.setStyle("-fx-font-size: 24px; -fx-fill: yellow; -fx-font-weight: bold; -fx-font-family: 'Times New Roman';");
            StackPane.setAlignment(timeText, javafx.geometry.Pos.TOP_CENTER); // Position at the top
            ...
            root.getChildren().addAll(canvas, timeText); // Add the text above the canvas
            ...
            new AnimationTimer() {
                ...
                public void handle(long arg0) {
                    ...
                    if (gameOver) {
                        ...
                        timeText.setText(""); // Clears the text in case of game over
                    } else if (victory) {
                        mediator.drawBackground();
                        mediator.drawAgents();
