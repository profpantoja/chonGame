...
public class GameSet {
    ...
    private void load() {
         ...
         */
        Agent magician = new Agent(920, 440, 90, 65, 1, 2000, "/images/agents/magic.png", true, true);
         ...
         */
        Agent goblin1 = new Agent(200, 400, 90, 65, 2, 1500, "/images/agents/goblin.png", true, true);
        Agent goblin2 = new Agent(920, 440, 90, 65, 3, 2500, "/images/agents/goblin.png", true, true);
        Agent goblin3 = new Agent(500, 700, 90, 65, 2, 1500, "/images/agents/goblin.png", true, true);
        ...
        */
        ...
        Agent golem = new Agent(1000, 440, 90, 65, 1, 10000, "/images/agents/golemRun.png", true, true);
