...
public class Agent extends Entity {
     ...
     */
    public Agent(int posX, int posY, int width, int speed, int health, Direction direction, boolean flipped,
            boolean visibleBars) {
        super(posX, posY, width, speed, health, direction, flipped, visibleBars);
        this.energy = 1.0;
        this.fullEnergy = 1.0;
